...
labels_train = np.reshape(labels_train, (10500, 1))
...
test_sets = 30
np.savetxt("word2vec_train.txt", all_data[0:(num_sentences - num_testing)], delimiter=",")
np.savetxt("word2vec_test.txt", all_data[(num_sentences - num_testing):], delimiter=",")
