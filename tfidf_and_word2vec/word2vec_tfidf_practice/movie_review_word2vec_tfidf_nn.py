...
class AllData(Dataset):
    ...
    def __init__(self, in_file):
        x = np.loadtxt(in_file, usecols=range(0, 1300),
                             delimiter=",", comments="#", dtype=np.float32)
        
        y = np.loadtxt(in_file, usecols=[1300],
                             delimiter=",", comments="#", dtype=np.float32)
...
train_file = "word2vec_train.txt"
test_file = "word2vec_test.txt"
...
model = NeuralNetwork(num_inputs=1300, num_outputs=1)
